...
/* TODO */
domainLiteral: DOMAIN_LITERAL;
/* TODO */
tldLiteral: TLD_LITERAL;
/* TODO */
...
//--------------------------------------------------------------------------------------------------
/* TODO */
module: 'MODULE' STRING_LITERAL ('DESCRIPTION' STRING_LITERAL)? ('ICON' urlLiteral) rule*;

//--------------------------------------------------------------------------------------------------
// rules
//--------------------------------------------------------------------------------------------------
/* TODO */
rule: ignored? ('AT' at)+ ('FROM' from ('APPLY' apply+)?) 'DO' do;
/* TODO */
ignored: 'IGNORED';
/* TODO */
at: at_anywhere | at_urlPattern | at_matching;
/* TODO */
at_anywhere: 'ANYWHERE';
/* TODO */
at_urlPattern: 'URL' 'PATTERN' urlLiteral*;
/* TODO */
at_matching: 'MATCHING' at_scheme? at_port? at_hostname? at_pathname? at_queryEntries? at_fragment?;
/* TODO */
at_scheme: 'SCHEME' abstractAtomLiteral*;
/* TODO */
at_port: 'PORT' abstractAtomLiteral*;
/* TODO */
at_hostname: 'HOSTNAME' (abstractAtomLiteral | domainLiteral| tldLiteral)*;
/* TODO */
at_pathname: 'PATHNAME' abstractAtomLiteral*;
/* TODO */
at_queryEntries: 'QUERY ENTRIES' abstractAtomLiteral*;
/* TODO */
at_fragment: 'FRAGMENT' abstractAtomLiteral*;
/* TODO */
from: from_pathname | from_queryEntries;
/* TODO */
from_pathname: 'PATHNAME';
/* TODO */
from_queryEntries: 'QUERY ENTRIES';
/* TODO */
apply: apply_functionCall+;
/* TODO */
apply_functionCall: apply_functionName (stringLiteral | numberLiteral)*;
/* TODO */
apply_functionName: FUNCTION_NAME;
/* TODO */
do: do_actionRemove | do_actionRemoveAll | do_actionRetain | do_actionRedirect;
/* TODO */
do_actionRemove: 'REMOVE' abstractPrimitiveLiteral*;
/* TODO */
do_actionRemoveAll: 'REMOVE' 'ALL';
/* TODO */
do_actionRetain: 'RETAIN' abstractPrimitiveLiteral*;
/* TODO */
do_actionRedirect: 'REDIRECT';
...
//--------------------------------------------------------------------------------------------------
/* TODO */
SUFFIX_LITERAL: STRING_LITERAL '$';

//--------------------------------------------------------------------------------------------------
// prefix splits
//--------------------------------------------------------------------------------------------------
/* TODO */
PREFIX_SPLIT_LITERAL: STRING_LITERAL '^' STRING_LITERAL;

//--------------------------------------------------------------------------------------------------
// suffix splits
//--------------------------------------------------------------------------------------------------
/* TODO */
SUFFIX_SPLIT_LITERAL: STRING_LITERAL '$' STRING_LITERAL;
...
//--------------------------------------------------------------------------------------------------
/* TODO */
DOMAIN_LITERAL: '*' STRING_LITERAL;

//--------------------------------------------------------------------------------------------------
// domains
//--------------------------------------------------------------------------------------------------
/* TODO */
TLD_LITERAL: STRING_LITERAL '*';
