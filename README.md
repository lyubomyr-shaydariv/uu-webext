...
* ![commissionfactory](favicons/commissionfactory.com.png) Commission Factory (redirects)
...
* ![gog](favicons/gog.com.png) GOG (URLs)
* ![goodreads](favicons/goodreads.com.png) Goodreads (URLs)
...
* ![guardian](favicons/theguardian.com.png) The Guardian (URLs)
* ![hackernoon](favicons/hackernoon.com.png) HackerNoon (URLs)
* ![harvardbusinessreview](favicons/hbr.org.png) Harvard Business Review (URLs)
* ![hive](favicons/hive.co.png) Hive (URLs)
* href.li (redirects)
* ![hubspot](favicons/hubspot.com.png) HubSpot (URLs)
* ![humblebundle](favicons/humblebundle.com.png) Humble Bundle (URLs)
* ![iacr](favicons/iacr.org.png) IACR (URLs)
* ![ibm](favicons/ibm.com.png) IBM (URLs)
* icptrack (redirects)
* ![imdb](favicons/imdb.com.png) IMDb (URLs and redirects)
* ![impact](favicons/impact.com.png) Impact (ex-Impact Radius) (URLs)
